...
class SettingsTable extends Table
{
    ...
    public function validationDefault(Validator $validator)
    {
        ...
        $validator
            ->scalar('Institutename')
            ->maxLength('Institutename', 255)
            ->requirePresence('Institutename', 'create')
            ->notEmpty('Institutename');

        $validator
            ->scalar('adminemailId')
            ->maxLength('adminemailId', 255)
            ->requirePresence('adminemailId', 'create')
            ->notEmpty('adminemailId');
